...
const game = {
  ...
  players: [['neuer','pavard', 'martiniz', 'alva', 'devines', 'kiminich', 'gorteza' , 'coman', 'muller', 'granby', 'lewandoski',]
  ['burkhi', 'hmulleus', 'schullez', 'akanji','hakimi','whegil', 'wistel', 'hazard', 'brandart', 'sancho','gotze'],
  ],
  score:'4:0',
  scored:['lewandoski','granby','lewandoski','hmulleus'],
  date : 'nov 9th 2037',
  odds:{
    team1:1.33,
    x:3.25,
